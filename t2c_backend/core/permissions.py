...
class Permissions(BaseFlags):
    ...
    @FlagValue
    def shelf_system_create(self) -> int:
        return 1 << 26

    @FlagValue
    def shelf_system_update(self) -> int:
        return 1 << 27

    @FlagValue
    def shelf_system_read(self) -> int:
        return 1 << 28

    @FlagValue
    def shelf_system_delete(self) -> int:
        return 1 << 29

    @FlagValue
    def shelf_create(self) -> int:
        return 1 << 30

    @FlagValue
    def shelf_update(self) -> int:
        return 1 << 31

    @FlagValue
    def shelf_read(self) -> int:
        return 1 << 32

    @FlagValue
    def shelf_delete(self) -> int:
        return 1 << 33

    @FlagValue
    def rack_create(self) -> int:
        return 1 << 34

    @FlagValue
    def rack_update(self) -> int:
        return 1 << 35

    @FlagValue
    def rack_read(self) -> int:
        return 1 << 36

    @FlagValue
    def rack_delete(self) -> int:
        return 1 << 37

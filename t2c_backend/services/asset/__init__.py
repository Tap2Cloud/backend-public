...
class AssetService:
    ...
    async def create_asset(
        ...
        asset = Asset(
            ...
            pass_id=self.app.clients.cryptography.encode(asset_data.device_id),
    ...
    async def update_asset(
        ...
        return await self.repository.save(current_db_asset)
    ...
    async def list_assets_by_location_id(self, location_id: int):
    ...
    async def list_assets(
        ...
        if status:
            status_condition = BaseRepository.parse_filters(self._model, status=status)
